...
#### 📋 Agent Manifest Purpose
- **Used for**: Agent-to-agent communication and work handoffs
- **Contains**: Work orders, context, metadata, coordination instructions
- **Generated by**: Project coordinators when assigning tasks to agents
- **Used by**: Agents receiving work assignments from other agents
- **Format**: Structured template with task details, context, and coordination protocols
